...
//            0xB7, 1, 0x06,      //Entry Mode Set [06]
    ...
    case 0x1581:                        //no BGR in MADCTL.  set BGR in Panel Control
        ...
        static const uint8_t R61581_regValues_bodmer[] PROGMEM = {    // 320x480
            (0xB0), 1, 0x00,
            // (0xB3), 4,0x02,0x00,0x00,0x10, //WEMODE=1,TE1=0,DENC=0,EPF=1
            (0xD0), 3, 0x07, 0x42, 0x18, //WCB=1,WCV=1,?VC=0x42,VRH=0x18
            (0xD1), 3, 0x00, 0x07, 0x10, //WCVCV=0,WCVDM=0,VCM=0x07,VDV=0x10
            (0xD2), 2, 0x01, 0x02,    //AP0=1,DC10=0,DC00=2
            (0xC0), 5, 0x12, 0x3B, 0x00, 0x02, 0x11, //REV=1,SM=0,GS=0,BGR=1,SS=0,NL=0x3B,SCN=0,BLV=1,PTV=0,NDL=1,PTDC=0,PTS=1
            // (0xC1), 4,0x08,0x15,0x08,0x08, //BC0=1,DIV0=0,RTN=0x15,BP0=0x08,FP0=0x08
            // (0xC5), 1,0x03,           //??
            (0xC6), 1, 0x02,               //VSPL=0,HSPL=0,EPL=1,DPL=0
            (0xC8), 12, 0x00, 0x32, 0x36, 0x45, 0x06, 0x16, 0x37, 0x75, 0x77, 0x54, 0x0C, 0x00,
        };
        static const uint8_t R61581_regValues_tontec[] PROGMEM = {    // 320x480
            (0xB0), 1, 0x00,
            0xB3, 4, 0x02, 0x00, 0x00, 0x00,
            0xC0, 8, 0x12, 0x3B, 0x00, 0x02, 0x00, 0x01, 0x00, 0x43,
            0xC1, 4, 0x08, 0x16, 0x08, 0x08,
            0xC4, 4, 0x11, 0x07, 0x03, 0x03,
            0xC6, 1, 0x00,
            0xC8, 20, 0x03, 0x03, 0x13, 0x5C, 0x03, 0x07, 0x14, 0x08, 0x00, 0x21, 0x08, 0x14, 0x07, 0x53, 0x0C, 0x13, 0x03, 0x03, 0x21, 0x00,
            0xD0, 4, 0x07, 0x07, 0x1D, 0x03,
            0xD1, 3, 0x03, 0x30, 0x10,
            0xD2, 3, 0x03, 0x14, 0x04,
        };
        static const uint8_t R61581_regValues_aurora[] PROGMEM = {    // 320x480
            (0xB0), 1, 0x00,
            (0xB3), 4, 0x02, 0x00, 0x00, 0x00,
            (0xB4), 1, 0x00,
            (0xC0), 8, 0x12, 0x3B, 0x00, 0x02, 0x00, 0x01, 0x00, 0x43,
            (0xC1), 4, 0x08, 0x17, 0x08, 0x08,

            (0xC4), 4, 0x22, 0x02, 0x00, 0x00,
            (0xC8), 20, 0x09, 0x08, 0x10, 0x85, 0x07, 0x08, 0x16, 0x05, 0x00, 0x32, 0x05, 0x16, 0x08, 0x88, 0x09, 0x10, 0x09, 0x04, 0x32, 0x00,
            (0xD0), 4, 0x07, 0x07, 0x16, 0x72,
            (0xD1), 3, 0x03, 0x3A, 0x0A,
            (0xD2), 3, 0x02, 0x44, 0x04,
        };

        //        table8_ads = R61581_regValues, table_size = sizeof(R61581_regValues);
        table8_ads = R61581_regValues_bodmer, table_size = sizeof(R61581_regValues_bodmer);
        //        table8_ads = R61581_regValues_tontec, table_size = sizeof(R61581_regValues_tontec);
        //        table8_ads = R61581_regValues_aurora, table_size = sizeof(R61581_regValues_aurora);
        p16 = (int16_t *) & HEIGHT;
        *p16 = 480;
        p16 = (int16_t *) & WIDTH;
        *p16 = 320;
